...
var Book = function Book(_ref) {
  var config = _ref.config,
      userAgent = _ref.userAgent,
      reservationPage = _ref.reservationPage;
  return [__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_container_app__["default"], {
    ...
    className: "book"
  }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h1", null, __WEBPACK_IMPORTED_MODULE_6__utils_localize___default()('book_title', config.translations)), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("section", {
    dangerouslySetInnerHTML: {
      __html: reservationPage.content
    }
...
function () {
  ...
  __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee(_ref2) {
    var req, lang, _ref4, translations, settings, reservationPage;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 8;
            return Object(__WEBPACK_IMPORTED_MODULE_3__utils_ajax__["a" /* getJson */])(req, "/api/".concat(encodeURIComponent(lang || settings.defaultLanguage), "/reservation-page"));

          case 8:
            reservationPage = _context.sent;
