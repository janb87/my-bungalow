...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__styles_spacing__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__styles_screenSizes__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_localize__ = __webpack_require__(1);
...
var Park = function Park(_ref) {
  var config = _ref.config,
      userAgent = _ref.userAgent,
      parkPage = _ref.parkPage;
  var photos = parkPage.images.map(function (_ref2) {
    var url = _ref2.url,
        width = _ref2.width,
        height = _ref2.height;
    return {
  ...
  return [__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_container_app__["default"], {
    ...
    className: "park"
  }, __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h1", null, __WEBPACK_IMPORTED_MODULE_6__utils_localize___default()('the_park_title', config.translations)), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("section", {
    dangerouslySetInnerHTML: {
      __html: parkPage.intro
    }
  }), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h2", null, __WEBPACK_IMPORTED_MODULE_6__utils_localize___default()('the_park_accomodations', config.translations)), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("section", {
    dangerouslySetInnerHTML: {
      __html: parkPage.accomodations
    }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 8;
            return Object(__WEBPACK_IMPORTED_MODULE_3__utils_ajax__["a" /* getJson */])(req, "/api/".concat(encodeURIComponent(lang || settings.defaultLanguage), "/park-page"));

          case 8:
            parkPage = _context.sent;
